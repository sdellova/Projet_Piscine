...
{
    //std::cout << "Opening SVG output file : " << m_filename << std::endl;
...
void Svgfile::addRectangle(std::string id, double x, double y, double width, double height, std::string color, std::string border)
{
    m_ostrm << "<rect "
            << attrib("id", id)
            << attrib("x", x+100)
